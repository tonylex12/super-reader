  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        ...
        <View style={{ backgroundColor: colors.sheetBg, borderColor: colors.border }} className="w-full max-w-md rounded-t-3xl border-t border-x p-6 shadow-2xl absolute bottom-0">
